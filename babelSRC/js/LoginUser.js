  ...
  constructor() {
    ...
    this.stateVersionObserver = it => {
      switch (it) {
        ...
        case "SUCCESS":
          document.getElementById("progress").style.visibility = "hidden";
          this.viewModelLogin.getIsValidAccount(this.stateObserver, this.existDriverObserver, document.getElementById("email").value, document.getElementById("password").value);
          break;
        case "ERROR":
          document.getElementById("progress").style.visibility = "hidden";
          break;
