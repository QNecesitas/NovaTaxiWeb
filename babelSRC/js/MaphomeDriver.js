    ...
    if (this.viewModel.listDrivers) {
      for (let f = 0; f < this.viewModel.listDrivers.length; f++) {
        if (this.viewModel.listDrivers[f].longitude !== 0.0 && this.viewModelMapHome.listDrivers[f].latitude !== 0.0) {
          this.addAnnotationDrivers(new Point(this.viewModel.listDrivers[f].longitude, this.viewModel.listDrivers[f].latitude), this.getDriverMarkerImg(this.viewModel.listDrivers[f].typeCar));
        }
      }
    }
  }
